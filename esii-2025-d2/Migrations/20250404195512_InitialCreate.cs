        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TalentCategoryId = table.Column<int>(type: "integer", nullable: true),
                    UserId = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_JobProposals_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_JobProposals_Skills_SkillId",
                        column: x => x.SkillId,
                        principalTable: "Skills",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_JobProposals_TalentCategories_TalentCategoryId",
                        column: x => x.TalentCategoryId,
                        principalTable: "TalentCategories",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobProposals_CustomerId",
                table: "JobProposals",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_JobProposals_SkillId",
                table: "JobProposals",
                column: "SkillId");

            migrationBuilder.CreateIndex(
                name: "IX_JobProposals_TalentCategoryId",
                table: "JobProposals",
                column: "TalentCategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_Talents_TalentCategoryId",
                table: "Talents",
                column: "TalentCategoryId");
